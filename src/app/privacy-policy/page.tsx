...
export async function generateMetadata() {
    ...
    return generatePageMetadata({
        title: metaTitle || title || "Privacy Policy | Forsikringtipset.no",
        description: metaDescription || "Forsikringtipset.no privacy policy page",
        path: "/privacy-policy",
        keywords: metaKeywords
            ? metaKeywords.split(',').map((k: string) => k.trim()).filter(Boolean)
            : ["privacy policy", "forsikringtipset", "terms and conditions", "data privacy", "user data"],
        type: "website",
        image: metaImage || null,
        ogTitle: ogTitle || metaTitle || title || "Privacy Policy | Forsikringtipset.no",
        ogDescription: ogDescription || metaDescription || "Learn how Forsikringtipset.no protects your privacy and handles your personal information.",
