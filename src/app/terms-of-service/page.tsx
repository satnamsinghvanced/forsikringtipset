...
export async function generateMetadata() {
  ...
  return generatePageMetadata({
    title: metaTitle || title || "Terms of Service | Forsikringtipset.no",
    description: metaDescription || "Forsikringtipset.no terms of service page",
    path: "/terms",
    keywords: metaKeywords
      ? metaKeywords.split(',').map((k: string) => k.trim()).filter(Boolean)
      : ["terms of service", "forsikringtipset", "legal", "user agreement", "terms and conditions"],
    type: "website",
    image: metaImage || null,
    ogTitle: ogTitle || metaTitle || title || "Terms of Service | Forsikringtipset.no",
    ogDescription: ogDescription || metaDescription || "Learn the terms of service for Forsikringtipset.no",
