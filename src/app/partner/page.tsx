...
export async function generateMetadata() {
    ...
    return generatePageMetadata({
        ...
        description: metaDescription || subHeading || "Learn more about becoming a Forsikringtipset partner",
        path: slug || "/partner",
        keywords: metaKeywords
            ? metaKeywords.split(',').map((k: string) => k.trim()).filter(Boolean)
            : ["partner", "forsikringtipset", "business", "collaboration"],
        type: ogType || "website",
        image: metaImage || ogImage || image || null,
        ogTitle: ogTitle || metaTitle || heading || "Partner",
        ogDescription: ogDescription || metaDescription || subHeading || "Join the Forsikringtipset network and collaborate with us",
