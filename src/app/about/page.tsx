...
export async function generateMetadata() {
  ...
  return generatePageMetadata({
    title: metaTitle || heading || "About Forsikringtipset.no",
    description: metaDescription || subHeading || "Learn more about Forsikringtipset.no",
    path: slug || "/about",
    keywords: metaKeywords ? metaKeywords.split(',').map((k: string) => k.trim()).filter(Boolean) : ["about", "forsikringtipset", "real estate"],
    type: ogType || "website",
    image: metaImage || ogImage || image || null,
    ogTitle: ogTitle || metaTitle || heading || "About Forsikringtipset.no",
    ogDescription: ogDescription || metaDescription || subHeading || "Learn more about Forsikringtipset.no",
