...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return generatePageMetadata({
        title: metaTitle || heading || "Real Estate Agents | Forsikringtipset.no",
        description: metaDescription || subHeading || "Welcome to Forsikringtipset.no — compare and find the best real estate agents in Norway.",
        path: "/",
        keywords: metaKeywords ? metaKeywords.split(",").map((k: string) => k.trim()).filter(Boolean) : ["forsikringtipset", "real estate", "agents", "compare"],
        type: ogType || "website",
        image: metaImage || ogImage || bannerImage || null,
        ogTitle: ogTitle || metaTitle || "Real Estate Agents | Forsikringtipset.no",
        ogDescription: ogDescription || metaDescription || "Compare top real estate agents in Norway easily with Forsikringtipset.no.",
        canonicalUrl: canonicalUrl,
        robots: robots || "index, follow",
        jsonLd: jsonLd || {
            "@context": "https://schema.org",
            "@type": "WebSite",
            name: "Forsikringtipset.no",
        },
