...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    title: metaTitle || `${category} Articles | Forsikringtipset.no`,
    description: metaDescription || `Read expert articles about ${category} on Forsikringtipset.no.`,
    path: finalCanonical,
    keywords: metaKeywords ? metaKeywords.split(",").map((k: string) => k.trim()).filter(Boolean) : ["forsikringtipset", category, "real estate", "articles"],
    type: ogType || "website",
    image: ogImage || null,
    ogTitle: ogTitle || metaTitle || `${category} Articles | Forsikringtipset.no`,
    ogDescription: ogDescription || metaDescription || `Explore helpful ${category} articles from Forsikringtipset.no.`,
