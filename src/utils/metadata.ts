...
export async function generatePageMetadata({
    ...
    const pageTitle = title ? (title == 'Forsikringtipset.no' ? `Forsikringtipset.no` : `${title} |  Forsikringtipset.no`) : ' Forsikringtipset.no';
    const ogFinalTitle = ogTitle ? `${ogTitle} | Forsikringtipset.no` : pageTitle;
